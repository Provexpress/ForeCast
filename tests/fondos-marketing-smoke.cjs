...
assert.match(html, /src\/styles\/main\.css\?v=20260818-fondos-card1/);
...
assert.match(html, /src\/scripts\/fondos-marketing\.js\?v=20260818-fondos-card1/);
assert.match(html, /src\/scripts\/main\.js\?v=20260818-fondos-card1/);
